...
# NOTE: "Language Detection" is intentionally duplicated. The first column holds the
# ISO code reported by the detector, while the second stores the confidence score.
